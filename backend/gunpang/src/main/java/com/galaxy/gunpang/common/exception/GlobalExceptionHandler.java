...
import com.galaxy.gunpang.common.exception.GunpangApiException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    @ExceptionHandler(GunpangApiException.class)
    protected ResponseEntity<Object> handleApiException(GunpangApiException exception,
                                                        WebRequest request) {
        log.error("GunpangApiException({}) 발생 :  {}",exception.getClass().getName(), exception.getMessage());
